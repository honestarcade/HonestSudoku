...
/// three of those pairs it cannot: no unique 4×4 board with at least the
/// design's floor of givens needs more than naked singles, and no 6×6 board
/// at the uniqueness limit needed a triple or an X-wing. So 4×4 is Easy only
/// and 6×6 stops at Hard — the owner's "unsupported pairs are unavailable"
/// rule, applied to what was measured. `test/engine/difficulty_test.dart`
/// executes both claims; the full measurements are in the decision log
/// (2026-09-23).
