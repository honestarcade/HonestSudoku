...
MUTATIONS: list[Mutation] = [
    ...
    # `slow=True`: the property guards are tagged `slow`, so the per-mutation
    # SUITE leaves them out and these entries run SUITE_SLOW.
