...
// Invariants 2 and 4 on 9×9 (see engine_guard_support.dart). Tagged
...
void main() {
  engineGuard(GridShape.classic, seeds: prSeeds(GridShape.classic));
  gradedGoldens(GridShape.classic);
}
